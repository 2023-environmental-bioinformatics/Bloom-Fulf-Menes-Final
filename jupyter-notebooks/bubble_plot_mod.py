#note from Avery: the following text is the script that the authors provided on their github for creating the bubble plots from an excel file.
#I tried following their code to create the bubble plots, but I found it almost impossible to reproduce because they did not provide any information
#about how they listed/formatted their data within the excel file. I did my best guess to create an excel file that would work with their method
#by manually copy-and-pasting from my output file, but I ended up needing to use my own script, which I've named bubble-plot-m?.ipynb. 
#I've included this script here for easy comparison.
